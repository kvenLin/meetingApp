...
//        return new Date(30 * 24 * 60);
    ...
    private Boolean isCreatedAfterRefreshMinutes(Date created) {
...
//        claims.put(CLAIM_KEY_AUDIENCE, generateAudience(device));
    ...
    public Boolean canTokenBeRefreshed(String token) {
        ...
        return token!=null&&created!=null&& isCreatedAfterRefreshMinutes(created)
...
//                        && !isCreatedAfterRefreshMinutes(created, user.getLastPasswordResetDate()))
    }
}